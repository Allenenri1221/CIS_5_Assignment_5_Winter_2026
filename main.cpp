...
int main() {
	...
	students[0] = {101, "Leo", 88.5f};
	students[1] = {102, "Roger", 92.0f};
	students[2] = {103, "Jin", 76.3f};
	students[3] = {104, "Ayleen", 85.0f};
	students[4] = {105, "Leeah", 90.4f};
